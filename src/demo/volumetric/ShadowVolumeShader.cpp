...
void ShadowVolumeShader::initialise(const SceneLeafLight& light_node, const glm::mat4& view_matrix, const glm::mat4& model_matrix, const glm::mat4& projection_matrix, const std::vector<const SceneLeafLight*>& lights)
{
...
void ShadowVolumeShader::initialise(const SceneLeafModel& model_node, const glm::mat4& view_matrix, const glm::mat4& model_matrix, const glm::mat4& projection_matrix, const SceneLeafLight& light, float camera_near_plane, float camera_far_plane, Texture& camera_depth_texture)
{
	...
	*/
	...
	glUniform1i(depth_texture_loc_, light.getLight().getShadowRenderer().getTexture().getActiveTextureId());
...
void ShadowVolumeShader::loadDepth(const Light& light)
{
