#ifndef DEMO_VOLUMETRIC_LIGHT_DEMO_H
#define DEMO_VOLUMETRIC_LIGHT_DEMO_H
...
class VolumetricLightDemo : public ApplicationInterface
{
public:
	VolumetricLightDemo(SceneManager& scene_manager);
