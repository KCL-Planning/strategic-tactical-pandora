...
#include "planning_msgs/ActionFeedback.h"
	...
	void testDisptachCallback(const planning_msgs::ActionDispatch::ConstPtr& msg)
	{
	...
	void testFeedbackCallback(const planning_msgs::ActionFeedback::ConstPtr& msg)
	{
	...
	{
		ros::init(argc, argv, "planning_msgs_listener");
		ros::NodeHandle n;
		ros::Subscriber dispatchSub = n.subscribe("action_dispatch", 1000, testDisptachCallback);
		ros::Subscriber feedbackSub = n.subscribe("action_feedback", 1000, testFeedbackCallback);
		ros::spin();
