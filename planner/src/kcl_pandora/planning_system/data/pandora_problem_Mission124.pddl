...
(:objects
auv0 - vehicle
inspection_point_78 - inspectionpoint
...
(= (observed inspection_point_78) 0)
(cansee auv0 strategic_location_1 inspection_point_78) (= (obs inspection_point_78 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_78) (= (obs inspection_point_78 strategic_location_1) 1)
...
(:goal (and
(>= (observed inspection_point_78) 1)
