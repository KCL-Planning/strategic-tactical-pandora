...
(:objects
auv0 - vehicle
inspection_point_180 - inspectionpoint
...
(= (observed inspection_point_180) 0)
(cansee auv0 strategic_location_1 inspection_point_180) (= (obs inspection_point_180 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_180) (= (obs inspection_point_180 strategic_location_1) 1)
(connected wp_AUV0 mission_site_start_point_3)  (= (distance wp_AUV0 mission_site_start_point_3) 70.7743)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 33.3467)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 33.3467)
)
(:goal (and
(>= (observed inspection_point_180) 1)
