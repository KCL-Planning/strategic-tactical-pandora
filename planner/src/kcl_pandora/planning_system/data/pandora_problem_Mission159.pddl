...
(:objects
auv0 - vehicle
inspection_point_93 - inspectionpoint
...
(= (observed inspection_point_93) 0)
(cansee auv0 strategic_location_1 inspection_point_93) (= (obs inspection_point_93 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_93) (= (obs inspection_point_93 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 70.7531)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 70.7531)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 48.4665)
...
(:goal (and
(>= (observed inspection_point_93) 1)
