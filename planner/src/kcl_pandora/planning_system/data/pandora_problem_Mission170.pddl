...
(:objects
auv0 - vehicle
inspection_point_103 - inspectionpoint
...
(= (observed inspection_point_103) 0)
(cansee auv0 strategic_location_1 inspection_point_103) (= (obs inspection_point_103 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_103) (= (obs inspection_point_103 strategic_location_1) 1)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 46.0543)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 42.3792)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 46.0543)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 46.0543)
...
(:goal (and
(>= (observed inspection_point_103) 1)
