...
(:objects
auv0 - vehicle
inspection_point_90 - inspectionpoint
...
(= (observed inspection_point_90) 0)
(cansee auv0 strategic_location_1 inspection_point_90) (= (obs inspection_point_90 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_90) (= (obs inspection_point_90 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 66.3777)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 66.3777)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 44.1475)
...
(:goal (and
(>= (observed inspection_point_90) 1)
