...
(:objects
auv0 - vehicle
inspection_point_169 - inspectionpoint
...
(= (observed inspection_point_169) 0)
(cansee auv0 strategic_location_1 inspection_point_169) (= (obs inspection_point_169 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_169) (= (obs inspection_point_169 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 122.707)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 122.707)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 60.7618)
...
(:goal (and
(>= (observed inspection_point_169) 1)
