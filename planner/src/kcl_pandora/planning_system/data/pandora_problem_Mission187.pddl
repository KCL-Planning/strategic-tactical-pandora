...
(:objects
auv0 - vehicle
inspection_point_120 - inspectionpoint
...
(= (observed inspection_point_120) 0)
(cansee auv0 strategic_location_1 inspection_point_120) (= (obs inspection_point_120 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_120) (= (obs inspection_point_120 strategic_location_1) 1)
(connected wp_AUV0 mission_site_start_point_2)  (= (distance wp_AUV0 mission_site_start_point_2) 63.3167)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 91.2414)
...
(connected mission_site_start_point_2 mission_site_start_point_2)  (= (distance mission_site_start_point_2 mission_site_start_point_2) 0)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 31.6228)
(connected mission_site_start_point_2 wp_AUV0)  (= (distance mission_site_start_point_2 wp_AUV0) 63.3167)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 31.6228)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 31.6228)
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 91.2414)
)
(:goal (and
(>= (observed inspection_point_120) 1)
