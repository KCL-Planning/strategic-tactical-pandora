...
(:objects
auv0 - vehicle
inspection_point_163 - inspectionpoint
...
(= (observed inspection_point_163) 0)
(cansee auv0 strategic_location_1 inspection_point_163) (= (obs inspection_point_163 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_163) (= (obs inspection_point_163 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 81)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 46.4327)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 81)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 46.4327)
(connected mission_site_start_point_3 strategic_location_1)  (= (distance mission_site_start_point_3 strategic_location_1) 46.4327)
...
(:goal (and
(>= (observed inspection_point_163) 1)
