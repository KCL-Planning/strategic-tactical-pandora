...
(:objects
auv0 - vehicle
inspection_point_37 - inspectionpoint
...
(cansee auv0 strategic_location_1 inspection_point_37) (= (obs inspection_point_37 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_37) (= (obs inspection_point_37 strategic_location_1) 1)
...
(connected mission_site_start_point_1 mission_site_start_point_1)  (= (distance mission_site_start_point_1 mission_site_start_point_1) 0)
(connected mission_site_start_point_1 strategic_location_1)  (= (distance mission_site_start_point_1 strategic_location_1) 34.0735)
(connected mission_site_start_point_1 wp_AUV0)  (= (distance mission_site_start_point_1 wp_AUV0) 22.561)
(connected mission_site_start_point_1 strategic_location_1)  (= (distance mission_site_start_point_1 strategic_location_1) 34.0735)
(connected strategic_location_1 mission_site_start_point_1)  (= (distance strategic_location_1 mission_site_start_point_1) 34.0735)
