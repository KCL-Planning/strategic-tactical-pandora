...
(:objects
auv0 - vehicle
inspection_point_160 - inspectionpoint
...
(= (observed inspection_point_160) 0)
(cansee auv0 strategic_location_1 inspection_point_160) (= (obs inspection_point_160 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_160) (= (obs inspection_point_160 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 73.0548)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 40.6448)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 73.0548)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 40.6448)
(connected mission_site_start_point_3 strategic_location_1)  (= (distance mission_site_start_point_3 strategic_location_1) 40.6448)
...
(:goal (and
(>= (observed inspection_point_160) 1)
