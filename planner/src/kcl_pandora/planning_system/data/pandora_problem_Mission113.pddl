...
(:objects
auv0 - vehicle
inspection_point_68 - inspectionpoint
...
(= (observed inspection_point_68) 0)
(cansee auv0 strategic_location_1 inspection_point_68) (= (obs inspection_point_68 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_68) (= (obs inspection_point_68 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 61.0082)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 61.0082)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 42.2493)
...
(:goal (and
(>= (observed inspection_point_68) 1)
