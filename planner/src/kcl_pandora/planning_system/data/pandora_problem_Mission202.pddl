...
(:objects
auv0 - vehicle
inspection_point_118 - inspectionpoint
...
(= (observed inspection_point_118) 0)
(cansee auv0 strategic_location_1 inspection_point_118) (= (obs inspection_point_118 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_118) (= (obs inspection_point_118 strategic_location_1) 1)
...
(:goal (and
(>= (observed inspection_point_118) 1)
