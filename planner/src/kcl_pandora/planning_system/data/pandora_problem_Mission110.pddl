...
(:objects
auv0 - vehicle
inspection_point_65 - inspectionpoint
...
(= (observed inspection_point_65) 0)
(cansee auv0 strategic_location_1 inspection_point_65) (= (obs inspection_point_65 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_65) (= (obs inspection_point_65 strategic_location_1) 1)
(connected wp_AUV0 mission_site_start_point_2)  (= (distance wp_AUV0 mission_site_start_point_2) 22.561)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 62.0161)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 62.0161)
)
(:goal (and
(>= (observed inspection_point_65) 1)
