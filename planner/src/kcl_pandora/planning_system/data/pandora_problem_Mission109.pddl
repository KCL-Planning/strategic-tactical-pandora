...
(:objects
auv0 - vehicle
inspection_point_64 - inspectionpoint
...
(= (observed inspection_point_64) 0)
(cansee auv0 strategic_location_1 inspection_point_64) (= (obs inspection_point_64 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_64) (= (obs inspection_point_64 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 63.8905)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 63.8905)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 50.05)
...
(:goal (and
(>= (observed inspection_point_64) 1)
