...
(:objects
auv0 - vehicle
inspection_point_189 - inspectionpoint
...
(= (observed inspection_point_189) 0)
(cansee auv0 strategic_location_1 inspection_point_189) (= (obs inspection_point_189 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_189) (= (obs inspection_point_189 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 82.1949)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 36.0694)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 82.1949)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 36.0694)
(connected mission_site_start_point_3 strategic_location_1)  (= (distance mission_site_start_point_3 strategic_location_1) 36.0694)
...
(:goal (and
(>= (observed inspection_point_189) 1)
