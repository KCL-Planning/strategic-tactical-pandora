...
(:objects
auv0 - vehicle
inspection_point_112 - inspectionpoint
...
(= (observed inspection_point_112) 0)
(cansee auv0 strategic_location_1 inspection_point_112) (= (obs inspection_point_112 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_112) (= (obs inspection_point_112 strategic_location_1) 1)
...
(:goal (and
(>= (observed inspection_point_112) 1)
