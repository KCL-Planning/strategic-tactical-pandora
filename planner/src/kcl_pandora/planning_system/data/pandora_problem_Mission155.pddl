...
(:objects
auv0 - vehicle
inspection_point_89 - inspectionpoint
...
(= (observed inspection_point_89) 0)
(cansee auv0 strategic_location_1 inspection_point_89) (= (obs inspection_point_89 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_89) (= (obs inspection_point_89 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 62.6578)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 62.6578)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 40.3609)
...
(:goal (and
(>= (observed inspection_point_89) 1)
