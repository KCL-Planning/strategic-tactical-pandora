...
(:objects
auv0 - vehicle
inspection_point_116 - inspectionpoint
...
(= (observed inspection_point_116) 0)
(cansee auv0 strategic_location_1 inspection_point_116) (= (obs inspection_point_116 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_116) (= (obs inspection_point_116 strategic_location_1) 1)
...
(:goal (and
(>= (observed inspection_point_116) 1)
