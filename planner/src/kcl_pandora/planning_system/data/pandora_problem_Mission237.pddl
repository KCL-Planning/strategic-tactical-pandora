...
(:objects
auv0 - vehicle
inspection_point_173 - inspectionpoint
...
(= (observed inspection_point_173) 0)
(cansee auv0 strategic_location_1 inspection_point_173) (= (obs inspection_point_173 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_173) (= (obs inspection_point_173 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 122.442)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 122.442)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 60.4731)
...
(:goal (and
(>= (observed inspection_point_173) 1)
