...
(:objects
auv0 - vehicle
inspection_point_72 - inspectionpoint
...
(= (observed inspection_point_72) 0)
(cansee auv0 strategic_location_1 inspection_point_72) (= (obs inspection_point_72 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_72) (= (obs inspection_point_72 strategic_location_1) 1)
...
(:goal (and
(>= (observed inspection_point_72) 1)
