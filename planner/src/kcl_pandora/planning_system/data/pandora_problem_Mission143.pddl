...
(:objects
auv0 - vehicle
inspection_point_95 - inspectionpoint
...
(= (observed inspection_point_95) 0)
(cansee auv0 strategic_location_1 inspection_point_95) (= (obs inspection_point_95 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_95) (= (obs inspection_point_95 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 59.5924)
...
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 59.5924)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 37.2055)
...
(:goal (and
(>= (observed inspection_point_95) 1)
