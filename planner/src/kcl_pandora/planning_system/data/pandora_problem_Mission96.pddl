...
(:objects
auv0 - vehicle
inspection_point_38 - inspectionpoint
...
(cansee auv0 strategic_location_1 inspection_point_38) (= (obs inspection_point_38 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_38) (= (obs inspection_point_38 strategic_location_1) 1)
...
(connected mission_site_start_point_1 mission_site_start_point_1)  (= (distance mission_site_start_point_1 mission_site_start_point_1) 0)
(connected mission_site_start_point_1 strategic_location_1)  (= (distance mission_site_start_point_1 strategic_location_1) 40.8044)
(connected mission_site_start_point_1 wp_AUV0)  (= (distance mission_site_start_point_1 wp_AUV0) 22.561)
(connected mission_site_start_point_1 strategic_location_1)  (= (distance mission_site_start_point_1 strategic_location_1) 40.8044)
(connected strategic_location_1 mission_site_start_point_1)  (= (distance strategic_location_1 mission_site_start_point_1) 40.8044)
