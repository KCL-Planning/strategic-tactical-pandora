...
(:objects
auv0 - vehicle
inspection_point_88 - inspectionpoint
...
(= (observed inspection_point_88) 0)
(cansee auv0 strategic_location_1 inspection_point_88) (= (obs inspection_point_88 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_88) (= (obs inspection_point_88 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 93.6056)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 42.2493)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 93.6056)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 42.2493)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 42.2493)
...
(:goal (and
(>= (observed inspection_point_88) 1)
