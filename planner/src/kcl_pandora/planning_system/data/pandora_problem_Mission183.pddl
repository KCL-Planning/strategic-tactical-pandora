...
(:objects
auv0 - vehicle
inspection_point_124 - inspectionpoint
...
(= (observed inspection_point_124) 0)
(cansee auv0 strategic_location_1 inspection_point_124) (= (obs inspection_point_124 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_124) (= (obs inspection_point_124 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 41.9524)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 31.0644)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 41.9524)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 31.0644)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 31.0644)
...
(:goal (and
(>= (observed inspection_point_124) 1)
