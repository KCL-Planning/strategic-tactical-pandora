...
(:objects
auv0 - vehicle
inspection_point_96 - inspectionpoint
...
(= (observed inspection_point_96) 0)
(cansee auv0 strategic_location_1 inspection_point_96) (= (obs inspection_point_96 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_96) (= (obs inspection_point_96 strategic_location_1) 1)
...
(connected mission_site_start_point_2 mission_site_start_point_2)  (= (distance mission_site_start_point_2 mission_site_start_point_2) 0)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 40.6448)
(connected mission_site_start_point_2 wp_AUV0)  (= (distance mission_site_start_point_2 wp_AUV0) 22.561)
(connected mission_site_start_point_2 strategic_location_1)  (= (distance mission_site_start_point_2 strategic_location_1) 40.6448)
(connected strategic_location_1 mission_site_start_point_2)  (= (distance strategic_location_1 mission_site_start_point_2) 40.6448)
...
(:goal (and
(>= (observed inspection_point_96) 1)
