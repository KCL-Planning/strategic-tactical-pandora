...
(:objects
auv0 - vehicle
inspection_point_167 - inspectionpoint
...
(= (observed inspection_point_167) 0)
(cansee auv0 strategic_location_1 inspection_point_167) (= (obs inspection_point_167 strategic_location_1) 1)
(cansee auv0 strategic_location_1 inspection_point_167) (= (obs inspection_point_167 strategic_location_1) 1)
(connected wp_AUV0 strategic_location_1)  (= (distance wp_AUV0 strategic_location_1) 80.5978)
...
(connected strategic_location_1 strategic_location_1)  (= (distance strategic_location_1 strategic_location_1) 0)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 46.0543)
(connected strategic_location_1 wp_AUV0)  (= (distance strategic_location_1 wp_AUV0) 80.5978)
(connected strategic_location_1 mission_site_start_point_3)  (= (distance strategic_location_1 mission_site_start_point_3) 46.0543)
(connected mission_site_start_point_3 strategic_location_1)  (= (distance mission_site_start_point_3 strategic_location_1) 46.0543)
...
(:goal (and
(>= (observed inspection_point_167) 1)
